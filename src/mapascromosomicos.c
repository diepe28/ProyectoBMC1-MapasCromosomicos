...
static void
mapascromosomicos_new_window (GApplication *app,
                           GFile        *file)
{
	GtkWidget *window;
...
static void
mapascromosomicos_activate (GApplication *application)
{
	mapascromosomicos_new_window (application, NULL);
}

static void
mapascromosomicos_open (GApplication  *application,
                     GFile        **files,
                     gint           n_files,
                     const gchar   *hint)
{
...
Mapascromosomicos *
mapascromosomicos_new (void)
{
	g_type_init ();

	return g_object_new (mapascromosomicos_get_type (),
	                     "application-id", "org.gnome.mapascromosomicos",
